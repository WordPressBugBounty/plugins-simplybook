...
//        ],
        'theme' => [
            ...
            'translations' => [
                ...
                'timeline_show_end_time' => __('Show end time', 'simplybook'),
                'timeline_modern_display' => __('Display calendar', 'simplybook'),
                'timeline_hide_unavailable' => __('Show only available time', 'simplybook'),
                'hide_past_days' => __('Hide unavailable days on calendar', 'simplybook'),
                'display_item_mode' => __('Display item mode', 'simplybook'),
                'body_bg_color' => __('Body background color', 'simplybook'),
                'sb_review_image' => __('Review image', 'simplybook'),
                'dark_font_color' => __('Dark base font color', 'simplybook'),
                'light_font_color' => __('Light base font color', 'simplybook'),
                'btn_color_1' => __('Buttons color', 'simplybook'),
                'sb_company_label_color' => __('Company title color', 'simplybook'),
                'hide_img_mode' => __('Hide images on booking steps', 'simplybook'),
                'show_sidebar' => __('Display calendar layout sidebar', 'simplybook'),
                'sb_busy' => __('Busy time color', 'simplybook'),
                'sb_available' => __('Available time color', 'simplybook'),
                'index_page_content_grid' => __('Index page content grid', 'simplybook'),
                'booking_nav_bg_color' => __('Navigation color', 'simplybook'),
                'hide_company_label' => __('Hide company title', 'simplybook'),
                'link_color' => __('Links color', 'simplybook'),
                'secondary_color' => __('Secondary color', 'simplybook'),
                'sb_text_color' => __('Text color', 'simplybook'),
                'sb_background_image' => __('Background image', 'simplybook'),
                'sb_cancellation_color' => __('Cancellation color', 'simplybook'),
                'img_fit_mode' => __('Image scale mode', 'simplybook'),
                'nav_bg_color' => __('Navigation background color', 'simplybook'),
                'sb_secondary_base' => __('Second Base theme color', 'simplybook'),
                'header_color' => __('Header color', 'simplybook'),
            ],
        ],
        'theme_settings' => [
            'id' => 'theme_settings',
